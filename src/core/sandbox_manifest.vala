namespace AppManager.Core {
    ...
    public class SandboxManifest {
        ...
        public static SandboxManifest from_record(InstallationRecord record) {
            ...
            m.portals = record.sandbox_use_portals;
        ...
        public string? to_data(string app_name) {
            ...
            try {
                ...
                kf.set_boolean(GROUP_PERMISSIONS, "portals", portals);
        ...
        public static SandboxManifest? read(string record_id) {
            ...
            m.portals = read_bool(kf, GROUP_PERMISSIONS, "portals", true);
        ...
        /**
         * Whether the manifest asks for anything that needs a filtered bus: either a
         * portal identity or one of the proxied services. With full_session_bus on,
         * the real socket is bound instead and no proxy is involved.
         */
        public bool needs_bus_proxy() {
            if (full_session_bus) {
                return false;
            }
            return portals || notifications || tray || bluetooth;
        }

        /**
         * Whether the system bus half of the proxy is needed.
         */
        public bool needs_system_bus() {
            return !full_session_bus && bluetooth;
        }
